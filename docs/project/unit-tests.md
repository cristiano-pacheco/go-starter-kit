...
5. Mocks and Stubs:
  ...
  - Example imports:
     - user_repository_mocks "github.com/cristiano-pacheco/go-starter-kit/internal/identity/domain/repository/mocks"
     - token_service_mocks "github.com/cristiano-pacheco/go-starter-kit/internal/identity/domain/service/mocks"
